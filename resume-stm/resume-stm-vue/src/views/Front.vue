  ...
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left">
        ...
        <div class="title" @click="router.push('/front/home')">在线简历生成与投递系统</div>
      </div>
        ...
        <div v-else>
          <el-dropdown style="cursor: pointer; height: 50px">
            <div style="display: flex; align-items: center">
              <img style="width: 35px; height: 35px; border-radius: 50%; border: 2px solid #000000" :src="data.user.avatar" alt="">
